...
const HELP: Record<string, Record<string, { title: string; body: string }>> = {
  ...
  pages: {
    ...
    es: { title: "Páginas", body: "Best Items — Buscá Pokémon (items que se usan) o Items (qué Pokémon lo usan). Ordenado por avg_rank global (rendimiento del item en TODOS los Pokémon, no uno específico). Usá filtro Min count.\n\nPokémon — Stats por tier. Muestra los 2-3 items más usados por frecuencia. Para ver qué equipa la gente.\n\nTop Pokémon / Top Items — Los mejores por avg_rank. Filtrable por tier.\n\nCompositions — Composiciones ganadoras del meta actual." },
