...
const HELP: Record<string, Record<string, { title: string; body: string }>> = {
  ...
  pages: {
    en: { title: "Pages", body: "• Best Items — Search by Pokémon (see items used on it) or by Item (see which Pokémon use it). Items ranked by global avg_rank across all Pokémon — a high rank means the item performs well in general, not necessarily on that specific Pokémon. Use Min count to filter out low-sample data.\n• Pokémon — Stats per Pokémon broken down by rank tier. Shows the 2-3 most used items per tier (frequency-based). Good for seeing what people actually equip.\n• Top Pokémon — Highest performing Pokémon by average rank, filterable by tier.\n• Top Items — Highest performing items by average rank, filterable by tier.\n• Compositions — Winning team compositions from the current meta." },
    es: { title: "Páginas", body: "• Best Items — Buscá por Pokémon (items que se usan en él) o por Item (qué Pokémon lo usan). Ordenado por avg_rank global del item — un rank alto significa que rinde bien en general, no necesariamente en ese Pokémon específico.\n• Pokémon — Stats por Pokémon separado por tier. Muestra los 2-3 items más usados (por frecuencia). Sirve para ver qué equipa la gente realmente.\n• Top Pokémon — Los Pokémon con mejor avg_rank, filtrable por tier.\n• Top Items — Los items con mejor avg_rank, filtrable por tier.\n• Compositions — Composiciones de equipo ganadoras del meta actual." },
    pt: { title: "Páginas", body: "• Best Items — Pesquise por Pokémon (itens usados nele) ou por Item (quais Pokémon usam ele). Ordenado por avg_rank global do item — um rank alto significa que o item vai bem em geral, não necessariamente naquele Pokémon específico.\n• Pokémon — Estatísticas por Pokémon separado por tier. Mostra os 2-3 itens mais usados (por frequência). Útil para ver o que as pessoas realmente equipam.\n• Top Pokémon — Os Pokémon com melhor avg_rank, filtrável por tier.\n• Top Items — Os itens com melhor avg_rank, filtrável por tier.\n• Compositions — Composições de equipe vencedoras do meta atual." },
  },
}
